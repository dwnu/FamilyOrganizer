# Privacy Policy for Kinppy - Family Organizer
...
Gathered data may include, but maybe not limited to: country, device model, device system, what screen did user visit, what element user clicked, 'device id', details (logs) about apllication crashes. Every text provided by user and gps location is used by the Service to fulfill its functionalities. 
